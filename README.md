...
```markdown
![GitHub Streak](https://dev.tuhidulhossain.com/api/streak?username=YOUR_USERNAME)
```
...
```markdown
![GitHub Streak](https://dev.tuhidulhossain.com/api/streak?username=YOUR_USERNAME&theme=tokyonight)
```
...
| Theme | Preview |
|-------|---------|
| `github_light` | ![github_light](https://dev.tuhidulhossain.com/api/streak?username=torvalds&theme=github_light) |
| `github_dark` | ![github_dark](https://dev.tuhidulhossain.com/api/streak?username=torvalds&theme=github_dark) |
| `tokyonight` | ![tokyonight](https://dev.tuhidulhossain.com/api/streak?username=torvalds&theme=tokyonight) |
| `dracula` | ![dracula](https://dev.tuhidulhossain.com/api/streak?username=torvalds&theme=dracula) |
| `nord` | ![nord](https://dev.tuhidulhossain.com/api/streak?username=torvalds&theme=nord) |
| `radical` | ![radical](https://dev.tuhidulhossain.com/api/streak?username=torvalds&theme=radical) |
| `sunset_dark` | ![sunset_dark](https://dev.tuhidulhossain.com/api/streak?username=torvalds&theme=sunset_dark) |
| `ocean_deep` | ![ocean_deep](https://dev.tuhidulhossain.com/api/streak?username=torvalds&theme=ocean_deep) |
| `cyber` | ![cyber](https://dev.tuhidulhossain.com/api/streak?username=torvalds&theme=cyber) |
| `aurora` | ![aurora](https://dev.tuhidulhossain.com/api/streak?username=torvalds&theme=aurora) |
